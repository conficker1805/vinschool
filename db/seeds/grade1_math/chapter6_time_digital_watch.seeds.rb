puts 'Creating MATH - Chapter 5 - Digital Watch'
...
question_template = QuestionTemplate.create!(
  ...
  slim_content: <<~TEXT
    ...
    .clock.mb-4
      ...
      .digital-watch
        .dw-hour.text-success.bold data-action="click->selector#openModal" data-modal-name="hourModal" data-replace="___" data-result=format('%02d', hour)
        span = ':'
        .dw-minute.text-success.bold data-action="click->selector#openModal" data-modal-name="minuteModal" data-replace="___" data-result=format('%02d', minute)
